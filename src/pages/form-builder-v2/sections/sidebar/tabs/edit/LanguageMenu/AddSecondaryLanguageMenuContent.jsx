...
import blocksFieldsData from '../../../../../data/BlocksFields.Data';
import { CheckIcon } from '../../../../../../form-builder/icons';
              ...
              const localDefaultField
                = (localItems[key].items[index].type !== 'inline'
                  && (inputFields[localItems[key].items[index].type]?.languages[
                    ...
                    || blocksFieldsData[localItems[key].items[index].type]?.languages[
                      secondaryLang
                    ]))
                || null;
              ...
              localItems[key].items[index].languages = {
                ...
                [secondaryLang]:
                  (localDefaultField && {
                    ...
                    rangeLabels: localDefaultField.rangeLabels,
