...
function LabelText({ isFieldLayout, title, description, dir, templateData }) {
  return (
...
export default function LayoutField({
  ...
  const [radioValue, setRadioValue] = React.useState(
    isFieldLayout ? templateData.fieldLayout : templateData.layout,
  );
        ...
        <FormControlLabel
          ...
          label={
            <LabelText
              ...
              description={
                isFieldLayout
                  ? `${t(`${translationPath}field-on-the-same-row`)}`
        ...
        <FormControlLabel
          ...
          label={
            <LabelText
              ...
              description={
                isFieldLayout
                  ? `${t(`${translationPath}field-on-different-rows`)}`
