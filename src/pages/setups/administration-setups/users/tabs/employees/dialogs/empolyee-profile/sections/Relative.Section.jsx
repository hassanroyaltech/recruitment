  ...
  return (
    <div>
      ...
      <SharedAPIAutocompleteControl
        ...
        getItemByIdAPI={getSetupsMaritalStatusById}
      ...
      <SharedAPIAutocompleteControl
        isFullWidth
        title="relative-type-uuid"
        errors={errors}
        isSubmitted={isSubmitted}
        stateKey="relative_type_uuid"
        errorPath="relative_type_uuid"
        placeholder="select-relative-type"
        onValueChanged={onStateChanged}
        editValue={state.relative_type_uuid}
        translationPath={translationPath}
        searchKey="search"
        getDataAPI={GetAllSetupsRelativeTypes}
        getItemByIdAPI={getSetupsRelativeTypesById}
        type={DynamicFormTypesEnum.select.key}
        parentTranslationPath={parentTranslationPath}
        getOptionLabel={(option) => option?.name?.en || ''}
        extraProps={{
          employee_uuid: filter.employee_uuid,
          ...(state.relative_type_uuid && { with_than: [state.relative_type_uuid] }),
        }}
        wrapperClasses="px-2"
      />
