...
export const DocumentForm = ({
  ...
  return (
    <div>
      ...
      <SharedAPIAutocompleteControl
        isHalfWidth
        title="document-type-uuid"
        errors={errors}
        isSubmitted={isSubmitted}
        stateKey="document_type_uuid"
        errorPath="document_type_uuid"
        placeholder="select-document"
        onValueChanged={onStateChanged}
        editValue={state.document_type_uuid}
        translationPath={translationPath}
        searchKey="search"
        getDataAPI={GetAllSetupsDocumentTypes}
        getItemByIdAPI={getSetupsDocumentTypesById}
        type={DynamicFormTypesEnum.select.key}
        parentTranslationPath={parentTranslationPath}
        getOptionLabel={(option) => option?.name?.en || ''}
        extraProps={{
          ...(state.document_type_uuid && { with_than: [state.document_type_uuid] }),
        }}
      />
