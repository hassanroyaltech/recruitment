  ...
  return (
    <div>
      <SharedAPIAutocompleteControl
        ...
        stateKey="asset_type_uuid"
        errorPath="asset_type_uuid"
        placeholder="select-asset"
        onValueChanged={onStateChanged}
        editValue={state.asset_type_uuid}
        translationPath={translationPath}
        searchKey="search"
        getDataAPI={GetAllSetupsAssetTypes}
        getItemByIdAPI={getSetupsAssetTypesById}
        type={DynamicFormTypesEnum.select.key}
        parentTranslationPath={parentTranslationPath}
        getOptionLabel={(option) => option?.name?.en}
        extraProps={{
          ...(state.asset_type_uuid && { with_than: [state.asset_type_uuid] }),
        }}
      />
      <SharedInputControl
        errors={errors}
        ...
        onValueChanged={(v) => {
          onStateChanged({
            id: 'name',
            value: { en: v.value, ar: state?.name?.ar || state.name_ar },
          });
          onStateChanged({
            id: 'name_en',
            value: v.value,
      ...
      <SharedInputControl
        ...
        onValueChanged={(v) => {
          onStateChanged({
            id: 'name',
            value: { en: state?.name?.en || state.name_en, ar: v.value },
          });
          onStateChanged({
            id: 'name_ar',
            value: v.value,
