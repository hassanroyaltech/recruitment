...
import {
  ...
  CreateSetupsPositionTitle,
  UpdateSetupsPositionTitle,
} from '../../../../../../services';
import './JobTitleManagement.Style.scss';
import { numericAndAlphabeticalAndSpecialExpression } from '../../../../../../utils';

export const JobTitleManagementDialog = ({
  isOpen,
  onSave,
  activeItem,
  isOpenChanged,
  ...
  const getEditInit = useCallback(async () => {
    setIsLoading(true);
    const response = await getSetupsPositionTitleById({
  ...
  const saveHandler = async (event) => {
    ...
    setIsLoading(true);
    let response;
    if (activeItem) response = await UpdateSetupsPositionTitle(state);
    else response = await CreateSetupsPositionTitle(state);
    setIsLoading(false);
...
JobTitleManagementDialog.propTypes = {
...
JobTitleManagementDialog.defaultProps = {
