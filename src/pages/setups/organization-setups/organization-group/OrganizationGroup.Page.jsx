...
import { OrganizationGroupManagementDialog } from './dialogs';
...
const OrganizationGroupPage = () => {
  ...
  const getAllCategories = useCallback(async () => {
    setIsLoading(true);
    const response = await GetAllSetupsOrganizationGroup({ ...filter });
    setIsLoading(false);
    ...
    <div className="organizationGroup-page page-wrapper">
      <div className="page-header-wrapper px-3 pb-3">
        ...
        <span className="description-text">
          {t(`${translationPath}business-group-description`)}
        </span>
      </div>
          ...
          <div className="px-2">
            ...
            <div className="d-inline-flex mb-2">
              <TableColumnsPopoverComponent
                ...
                feature_name={TablesNameEnum.OrganizationGroup.key}
            ...
            >
              ...
              <span className="px-2">{t(`${translationPath}import-${LookupsImportEnum.business_group.value}`)}</span>
            </ButtonBase>
            <ButtonBase
              disabled={
                !getIsAllowedPermissionV2({
            ...
            >
              ...
              <span className="px-1">
                {t(`${translationPath}add-business-group`)}
              </span>
            </ButtonBase>
          </div>
        </div>
      ...
      {isOpenManagementDialog && (
        <OrganizationGroupManagementDialog
      ...
      {isOpenLookupImportDialog && (
        <LookupImportDialog
          enumItem={LookupsImportEnum.business_group}
          onSave={() => {
            setFilter((items) => ({ ...items, page: items.page }));
          }}
          isOpenChanged={() => {
      ...
      {isOpenDeleteDialog && (
        <ConfirmDeleteDialog
          activeItem={activeItem}
          successMessage="business-group-deleted-successfully"
          onSave={() => {
          ...
          descriptionMessage="business-group-delete-description"
          deleteApi={DeleteSetupsOrganizationGroup}
          apiProps={{
            uuid:
              (isBulkDelete
          ...
          errorMessage="business-group-delete-failed"
          activeItemKey="uuid"
          apiDeleteKey="uuid"
