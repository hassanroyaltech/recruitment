...
export const SortByAutoCompleteControl = ({
  ...
  const updateCurrentEnums = useCallback(() => {
    const currentEnums = Object.values(ChannelsSortByEnum)
...
SortByAutoCompleteControl.propTypes = {
  ...
  filterBy: PropTypes.shape({
    order_by: PropTypes.oneOf(
      Object.values(ChannelsSortByEnum).map((item) => item.key),
    ),
    direction: PropTypes.oneOf(
      Object.values(ChannelsSortByEnum).map((item) => item.direction),
    ),
  }).isRequired,
