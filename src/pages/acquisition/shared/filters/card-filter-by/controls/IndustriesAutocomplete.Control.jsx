...
export const IndustriesAutocompleteControl = ({
  ...
  const getAllItemsByHelper = useCallback(async () => {
    setIsLoading(true);
    const response = await GetAllItemsByHelper('industry', { for_campaign: true });
  ...
  return (
    <div className="mb-2">
      <AutocompleteComponent
        ...
        data={data}
        labelValue="industries"
        multiple
        maxNumber={1}
        isDisabled={isDisabled}
        inputPlaceholder="select-industry"
...
IndustriesAutocompleteControl.propTypes = {
