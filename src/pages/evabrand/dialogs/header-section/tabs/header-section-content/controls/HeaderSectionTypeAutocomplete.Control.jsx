...
export const HeaderSectionTypeAutocompleteControl = ({
  editValue,
  onValueChanged,
  idRef,
  title,
  ...
  return (
    <div className="header-section-type-autocomplete-control-wrapper control-wrapper">
...
HeaderSectionTypeAutocompleteControl.propTypes = {
...
HeaderSectionTypeAutocompleteControl.defaultProps = {
  editValue: null,
  onValueChanged: undefined,
  linkValue: undefined,
  parentId: undefined,
  idRef: 'HeaderSectionTypeAutocompleteControlRef',
};
