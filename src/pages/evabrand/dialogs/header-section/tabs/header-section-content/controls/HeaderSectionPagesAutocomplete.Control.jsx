...
export const HeaderSectionPagesAutocompleteControl = ({
  data,
  editValue,
  onValueChanged,
  idRef,
  ...
  return (
    <div className="header-section-page-autocomplete-control-wrapper control-wrapper">
...
HeaderSectionPagesAutocompleteControl.propTypes = {
...
HeaderSectionPagesAutocompleteControl.defaultProps = {
  data: [],
  editValue: null,
  onValueChanged: undefined,
  parentId: undefined,
  idRef: 'HeaderSectionPagesAutocompleteControlRef',
};
