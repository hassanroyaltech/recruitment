...
export const HeaderSectionInputControl = ({
  editValue,
  onValueChanged,
  title,
  placeholder,
  ...
  return (
    <div className="header-section-input-control control-wrapper">
      <Inputs
        idRef={idRef}
        value={localValue}
...
HeaderSectionInputControl.propTypes = {
...
HeaderSectionInputControl.defaultProps = {
  editValue: null,
  onValueChanged: undefined,
  parentId: undefined,
  idRef: 'HeaderSectionInputControlRef',
};
