...
export const QuotesUploaderControl = ({
  mediaItem,
  onValueChanged,
  idRef,
  labelValue,
  ...
  return (
    <div className="quotes-uploader-control-wrapper control-wrapper">
      <UploaderComponent
        idRef={`${idRef}${index + 1}`}
        uploaderPage={UploaderPageEnum.EvaBrandQuotesTab}
        dropHereText={`${t('Shared:drop-here-max')} ${
          UploaderPageEnum.EvaBrandQuotesTab.maxFileNumber
        ...
        uploadedFiles={
          (mediaItem
            && (mediaItem[uuidStateKey] || mediaItem[urlStateKey]) && [
            {
              ...
              type: 'image',
              fileName: t(`${translationPath}quote-image`),
            },
          ])
          || []
        }
...
QuotesUploaderControl.propTypes = {
...
QuotesUploaderControl.defaultProps = {
  mediaItem: undefined,
  parentId: undefined,
  subParentId: undefined,
  index: undefined,
  onValueChanged: undefined,
  idRef: 'QuotesUploaderControl',
};
