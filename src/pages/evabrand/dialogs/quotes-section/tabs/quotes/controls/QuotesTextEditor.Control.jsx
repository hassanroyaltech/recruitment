...
export const QuotesTextEditorControl = ({
  editValue,
  onValueChanged,
  idRef,
  title,
  ...
  <div className="quotes-text-editor-control-wrapper control-wrapper">
    <TextEditorComponent
...
QuotesTextEditorControl.propTypes = {
...
QuotesTextEditorControl.defaultProps = {
  editValue: '',
  onValueChanged: undefined,
  parentId: undefined,
  subParentId: undefined,
  index: undefined,
  idRef: 'QuotesTextEditorControl',
};
