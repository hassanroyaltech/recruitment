...
export const CategoriesUploaderControl = ({
  mediaItem,
  onValueChanged,
  idRef,
  labelValue,
  ...
  return (
    <div className="categories-uploader-control-wrapper control-wrapper">
      <UploaderComponent
        idRef={`${idRef}${index + 1}`}
        uploaderPage={UploaderPageEnum.EvaBrandCategoriesTab}
        dropHereText={`${t('Shared:drop-here-max')} ${
          UploaderPageEnum.EvaBrandCategoriesTab.maxFileNumber
        ...
        uploadedFiles={
          (mediaItem
            && (mediaItem[uuidStateKey] || mediaItem[urlStateKey]) && [
            {
              ...
              type: 'image',
              fileName: t(`${translationPath}category-image`),
            },
          ])
          || []
        }
...
CategoriesUploaderControl.propTypes = {
...
CategoriesUploaderControl.defaultProps = {
  mediaItem: undefined,
  parentId: undefined,
