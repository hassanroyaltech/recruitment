...
export const MediasTextEditorControl = ({
  editValue,
  onValueChanged,
  idRef,
  title,
  ...
  <div className="medias-text-editor-control-wrapper control-wrapper">
    <TextEditorComponent
...
MediasTextEditorControl.propTypes = {
...
MediasTextEditorControl.defaultProps = {
  editValue: '',
  onValueChanged: undefined,
  parentId: undefined,
  subParentId: undefined,
  index: undefined,
  idRef: 'MediasTextEditorControlRef',
};
