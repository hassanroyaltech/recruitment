...
export const CategoriesCandidatePagesAutocompleteControl = ({
  data,
  editValue,
  onValueChanged,
  idRef,
  ...
  return (
    <div className="categories-candidate-pages-autocomplete-control-wrapper control-wrapper">
...
CategoriesCandidatePagesAutocompleteControl.propTypes = {
...
CategoriesCandidatePagesAutocompleteControl.defaultProps = {
  data: [],
  editValue: null,
  ...
  index: undefined,
  idRef: 'CategoriesCandidatePagesAutocompleteControlRef',
};
