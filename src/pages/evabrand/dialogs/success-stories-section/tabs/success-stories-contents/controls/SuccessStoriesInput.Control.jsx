...
export const SuccessStoriesInputControl = ({
  editValue,
  onValueChanged,
  title,
  placeholder,
  ...
  return (
    <div className="success-stories-input-control control-wrapper">
      <Inputs
        idRef={idRef}
        value={localValue}
...
SuccessStoriesInputControl.propTypes = {
...
SuccessStoriesInputControl.defaultProps = {
  editValue: null,
  onValueChanged: undefined,
  parentId: undefined,
  idRef: 'SuccessStoriesInputControlRef',
};
