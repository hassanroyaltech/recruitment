...
export const SuccessStoriesPagesAutocompleteControl = ({
  data,
  editValue,
  onValueChanged,
  idRef,
  ...
  return (
    <div className="success-stories-page-autocomplete-control-wrapper control-wrapper">
...
SuccessStoriesPagesAutocompleteControl.propTypes = {
...
SuccessStoriesPagesAutocompleteControl.defaultProps = {
  data: [],
  editValue: null,
  onValueChanged: undefined,
  parentId: undefined,
  idRef: 'SuccessStoriesPagesAutocompleteControlRef',
};
