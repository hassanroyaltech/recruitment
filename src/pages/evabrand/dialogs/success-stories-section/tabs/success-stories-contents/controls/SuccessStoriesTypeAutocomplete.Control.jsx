...
export const SuccessStoriesTypeAutocompleteControl = ({
  editValue,
  onValueChanged,
  idRef,
  title,
  ...
  return (
    <div className="success-stories-type-autocomplete-control-wrapper control-wrapper">
...
SuccessStoriesTypeAutocompleteControl.propTypes = {
...
SuccessStoriesTypeAutocompleteControl.defaultProps = {
  editValue: null,
  onValueChanged: undefined,
  linkValue: undefined,
  parentId: undefined,
  idRef: 'SuccessStoriesTypeAutocompleteControlRef',
};
