...
export const StoriesTextEditorControl = ({
  editValue,
  onValueChanged,
  idRef,
  title,
  ...
  <div className="stories-text-editor-control-wrapper control-wrapper">
    <TextEditorComponent
...
StoriesTextEditorControl.propTypes = {
...
StoriesTextEditorControl.defaultProps = {
  editValue: '',
  onValueChanged: undefined,
  parentId: undefined,
  subParentId: undefined,
  index: undefined,
  idRef: 'StoriesTextEditorControlRef',
};
