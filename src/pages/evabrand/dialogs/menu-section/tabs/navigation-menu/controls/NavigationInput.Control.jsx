...
export const NavigationInputControl = ({
  editValue,
  onValueChanged,
  title,
  placeholder,
  ...
  return (
    <div className="navigation-input-control control-wrapper">
      <Inputs
        idRef={`${idRef}${index + 1}`}
        value={localValue}
...
NavigationInputControl.propTypes = {
...
NavigationInputControl.defaultProps = {
  editValue: null,
  onValueChanged: undefined,
  parentId: undefined,
  subParentId: undefined,
  index: undefined,
  idRef: 'NavigationInputControlRef',
};
