...
export const GridTextEditorControl = ({
  editValue,
  onValueChanged,
  idRef,
  title,
  ...
  <div className="grid-text-editor-control-wrapper control-wrapper">
    <TextEditorComponent
...
GridTextEditorControl.propTypes = {
...
GridTextEditorControl.defaultProps = {
  editValue: '',
  onValueChanged: undefined,
  parentId: undefined,
  subParentId: undefined,
  index: undefined,
  idRef: 'GridTextEditorControlRef',
};
