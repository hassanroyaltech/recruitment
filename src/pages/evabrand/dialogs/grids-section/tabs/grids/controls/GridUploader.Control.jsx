...
export const GridUploaderControl = ({
  mediaItem,
  onValueChanged,
  idRef,
  labelValue,
  ...
  return (
    <div className="grid-uploader-control-wrapper control-wrapper">
      <UploaderComponent
        idRef={`${idRef}${index + 1}`}
        uploaderPage={UploaderPageEnum.EvaBrandGrid}
        dropHereText={`${t('Shared:drop-here-max')} ${
          UploaderPageEnum.EvaBrandGrid.maxFileNumber
        ...
        uploadedFiles={
          (mediaItem
            && (mediaItem[uuidStateKey] || mediaItem[urlStateKey]) && [
            {
              ...
              type: 'image',
              fileName: t(`${translationPath}grid-image`),
            },
          ])
          || []
        }
...
GridUploaderControl.defaultProps = {
  mediaItem: undefined,
  parentId: undefined,
  subParentId: undefined,
  index: undefined,
  onValueChanged: undefined,
  idRef: 'GridUploaderControlRef',
};
