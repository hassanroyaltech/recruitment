...
export const GridInputControl = ({
  ...
  return (
    <div className="grids-input-control control-wrapper">
      <Inputs
        idRef={`${idRef}${index + 1}`}
        value={localValue || ''}
...
GridInputControl.defaultProps = {
  editValue: null,
  onValueChanged: undefined,
  parentId: undefined,
  subParentId: undefined,
  index: undefined,
  idRef: 'GridInputControlRef',
};
