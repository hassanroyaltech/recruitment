...
export const MembersTextEditorControl = ({
  editValue,
  onValueChanged,
  idRef,
  title,
  ...
  <div className="members-text-editor-control-wrapper control-wrapper">
    <TextEditorComponent
...
MembersTextEditorControl.propTypes = {
...
MembersTextEditorControl.defaultProps = {
  editValue: '',
  onValueChanged: undefined,
  parentId: undefined,
  subParentId: undefined,
  index: undefined,
  idRef: 'MembersTextEditorControl',
};
