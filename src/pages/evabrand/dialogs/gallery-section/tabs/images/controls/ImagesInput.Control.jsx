...
export const ImagesInputControl = ({
  editValue,
  onValueChanged,
  title,
  placeholder,
  ...
  return (
    <div className="images-input-control control-wrapper">
      <Inputs
        idRef={`${idRef}${index + 1}`}
        value={localValue || ''}
...
ImagesInputControl.defaultProps = {
  editValue: null,
  onValueChanged: undefined,
  parentId: undefined,
  subParentId: undefined,
  index: undefined,
  idRef: 'ImagesInputControlRef',
};
