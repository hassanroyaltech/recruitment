...
export const DownloadPDFFormV1 = async ({
  pdfName = 'template',
  element,
  ref,
  isView = false,
          ...
          if (chlidrenArray[child].classList.contains('page-break-section')) {
            ...
            if (subChildren.length) {
              ...
              subChildren.forEach((subChild, index) => {
                if (
                  // subChildren[index].classList.contains('field-row-wrapper')
                  // &&
                  ...
                  if (index % 2 === 0) {
                    ...
                    if (
                      ...
                      const sepHeight
                        = a4Height * pageIndex
                        - (footersHeight + tempSubChildHeight + 5 + pageIndex);
                      separator.style.height = `${sepHeight}mm`;
                      helpArray.push(separator.cloneNode(true));
                      if (footersHeight)
                        imgFootersArray.forEach((element, index) => {
                      ...
                      // const margintop = a4Height * pageIndex - tempHeigth;
                      // subChild.style.marginTop = margintop + 'mm';
                      tempHeigth
                        = tempSubChildHeight
                  ...
                  if (
                    ...
                    const sepHeight
                      = a4Height * pageIndex
                      - (footersHeight + tempSubChildHeight + 5);
